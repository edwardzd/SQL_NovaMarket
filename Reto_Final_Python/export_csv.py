...
excel_path = '/Users/macbookpro/Developer/Learning/SQL/EXPLO_RA/S03_Ventas_Datos_Sucios_v4.xlsx'
...
csv_path = os.path.join(out_dir, 'S03_Ventas_Datos_Sucios_v4.csv')
